...
const productDescription = "gifgrep searches animated GIFs and extracts useful frames from the command line.";
const source = "https://github.com/steipete/gifgrep";
